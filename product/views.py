...
from .forms import ProductForm, Delete_Product_Form
...
class Page_Pagination:
    ...
    def get_page(self):
        ...
        self.paginator.get_page(page_number)
...
def delete_product(request, slug):
    product = DeleteProduct.objects.filter(slug=slug).delete()
    product_model = Product.objects.filter(slug=slug)
